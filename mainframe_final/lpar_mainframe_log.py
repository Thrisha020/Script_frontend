...
#    python3 lpar_mainframe_log.py MortgageApplication https://github.com/gmsadmin-git GMSRATN gmsrat GMSRATN hello.cbl '{"gmsmf": {"mfip": "13.233.106.52", "sshport": "2022", "groovyzpath": "/u/gmszfs/dbb20/usr/lpp/IBM/dbb/bin/groovyz",  "zappbuildpath": "/u/gmsratn/zAppbuild20/build.groovy"}}' /Users/thrisham/Desktop/cobol_code/mainframe_final

"""gmsmf:
  mfip: '13.233.165.158'
  sshport: '2022'
  groovyzpath: '/usr/lpp/IBM/dbb/bin/groovyz'
  zappbuildpath: '/tmp/ibmzappbuild/dbb-zappbuild/build.groovy'
  workspace: '/u/adcdmst/sandbox' 
  common_app_workspace: '/u/common/workspace/MortageApplication'
  outdir: '/u/zmszfs/sandbox/work'
#remove appliaction name
gmsstest:
  mfip: '13.233.165.158'
  sshport: '2022'
  groovyzpath: '/usr/lpp/IBM/dbb/bin/groovyz'
...
#    python3 lpar_mainframe_log.py MortgageApplication https://github.com/Thrisha020/ adcdmst sys3 ADCDMST.MORTGAGE hello.cbl '{"gmsmf": {"mfip": "13.233.165.158", "sshport": "2022", "groovyzpath": "/usr/lpp/IBM/dbb/bin/groovyz", "zappbuildpath": "/tmp/ibmzappbuild/dbb-zappbuild/build.groovy"}}' /Users/thrisham/Desktop/cobol_code/mainframe_final